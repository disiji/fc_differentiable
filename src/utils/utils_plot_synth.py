...
def plot_synth_depth3_tree_with_data(pickled_model, sample, figsize=(20, 12), ncols=7, hspace=None, wspace=0, init_gates='large_middle', size=1, saveas='testing_synth_tree.png', right=.7, top=.7, title='NAME ME'):
