...
def run_both_panels(hparams, random_state_start=0, model_checkpoint=True):
    ...
    for random_state in iterate_over:
        ...
        model_tree = ModelTreeBothPanels(hparams, cll_both_panels_input.features, cll_both_panels_input.reference_tree,
                                         init_tree=cll_both_panels_input.init_tree)
        dafi_tree = ModelTreeBothPanels(hparams, cll_both_panels_input.features, cll_both_panels_input.reference_tree,
                                        init_tree=None)
        ...
        model_tree, train_tracker_m, eval_tracker_m, run_time, model_checkpoint_dict = \
            run_train_full_batch_logreg_to_conv(hparams, cll_both_panels_input, model_tree,
